...
public class ContatoController {
	...
	public ResponseEntity<Contato> ListaUmContato(@PathVariable("idcontato") int idcontato) {
		try {
	...
	@PostMapping
	//@RequestBody pega o contato criado pelo cliente e transforma ele num obj da classe contato
